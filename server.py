...
def ask():
    ...
    system = """
        ...
        - Cuando cambies de tema o haya un salto importante, coloca una línea separadora con: --- (Ejemplo de uso: después de una introducción, antes de conclusiones, o entre secciones grandes)
